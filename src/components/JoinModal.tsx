  ...
  return (
    <div className="join-modal__overlay" role="dialog" aria-modal="true" aria-labelledby="join-modal-title">
      <div className="join-modal__card">
        ...
        <h2 id="join-modal-title" className="join-modal__title">Join Resonance Network</h2>
        <p className="join-modal__subtitle">
          Whether you&apos;re creating art or helping build it, there&apos;s a place for you here.
        </p>
        ...
        <div className="join-modal__paths">
          ...
          <div className="join-modal__path join-modal__path--share">
            ...
            <p className="join-modal__path-desc">
              You have a project and need the right people to help build it.
            </p>
            <Link href="/login?tab=signup&redirect=/dashboard/welcome" className="btn btn--primary join-modal__path-cta">
              Join Now &rarr;
            </Link>
          </div>
          ...
          <div className="join-modal__path join-modal__path--help">
            ...
            <p className="join-modal__path-desc">
              You&apos;re a maker or specialist ready to work on projects that matter.
            </p>
            <Link href="/login?tab=signup&redirect=/dashboard/welcome" className="btn btn--primary join-modal__path-cta">
              Join Now &rarr;
            </Link>
