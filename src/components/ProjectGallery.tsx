  ...
  return (
    <>
      ...
      {conceptProjects.length > 0 && (
        <section className="container container--wide" style={{ marginTop: 'var(--space-12)' }}>
          <div style={{ marginBottom: 'var(--space-4)' }}>
            <p className="section-label" style={{ marginBottom: 'var(--space-1)' }}>AI Concept Samples</p>
            <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-text-muted)', maxWidth: '50ch' }}>
              Fictional projects generated by AI to illustrate what the platform looks like in action.
            </p>
          </div>
          <div className={`project-grid${isTransitioning ? ' project-grid--transitioning' : ''}`}>
